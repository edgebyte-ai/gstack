...
ISSUE_ARTIFACT_TITLE="Eng plan: $(basename "$DESIGN" .md | sed 's/^[0-9]*-//')"
```
...
ISSUE_URL=$(~/.claude/skills/gstack/bin/gstack-issue-artifact create --kind gstack:eng-plan \
...
echo "[issue-artifacts] published gstack:eng-plan -> $ISSUE_URL"
```
<!-- @issue-artifacts:end -->
