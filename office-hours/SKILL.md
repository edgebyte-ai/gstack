...
Set the artifact path and title from the design doc just written, then publish:

```bash
ISSUE_ARTIFACT_PATH="$HOME/.gstack/projects/$SLUG/$USER-$BRANCH-design-$DATETIME.md"
ISSUE_ARTIFACT_TITLE="Design: $SLUG"
```
...
ISSUE_URL=$(~/.claude/skills/gstack/bin/gstack-issue-artifact create --kind gstack:design-doc \
